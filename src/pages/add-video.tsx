...
const AddVideo: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const catId = (video.category || "").trim();
...
if (!/^[0-9a-fA-F]{24}$/.test(catId)) {
  ...
  return;
    ...
    try {
      ...
      console.log("Submitting add-video payload:", payload);
      const res = await api.post("/videos", payload, { headers });
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white border rounded shadow-sm">
              ...
              <td colSpan={5} className="p-4 border bg-gray-50">
                <div className="flex items-center gap-3">
                  ...
                  <div className="ml-auto text-sm text-gray-500">
                    Tip: select sends category _id → backend saves into category_id.
                  </div>
                </div>
              </td>
            </tr>
